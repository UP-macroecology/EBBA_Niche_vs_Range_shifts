...
# read prepared EBBA data (output of 1_prep_EBBA_data.R):
...
length(unique(EBBA2_comp_sf$cell50x50)) # check: 2845
...
save(EBBA1_prep, EBBA2_prep, file = file.path("Data", "EBBA1_EBBA2_prep_steps1-4.RData"))