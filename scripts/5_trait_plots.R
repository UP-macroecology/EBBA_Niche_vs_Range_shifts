# explorative plots regarding niche / range dynamics and species traits:

# notes: plots not saved in subfolders
...
# use results for background = buffer around presences (TRUE) or background = whole EBBA-area / conterminous US (FALSE):
bg_spec <- TRUE
...
scatterplot_fun(data = res_traits_df, x = D_niche, y = D_range,
                ...
                title = paste0(dataset, ", background = ", ifelse(bg_spec, "buffer", "whole study area")),
...
scatterplot_fun(data = res_traits_df, x = niche_breadth_zcor, y = niche_expansion_std,
                ylab = "niche E", ylim = c(0, 0.3), xlab = "Niche breadth",
                title = paste0(dataset, ", background = ", ifelse(bg_spec, "buffer", "whole study area")), filename = "niche_E~Niche breadth.pdf",
                width = 8)
# range expansion:
scatterplot_fun(data = res_traits_df, x = niche_breadth_zcor, y = range_expansion_std,
                ylab = "range E", ylim = c(0, 0.3), xlab = "Niche breadth",
                title = paste0(dataset, ", background = ", ifelse(bg_spec, "buffer", "whole study area")), filename = "range_E~Niche breadth.pdf")

# niche unfilling:
scatterplot_fun(data = res_traits_df, x = niche_breadth_zcor, y = niche_unfilling_std,
                ylab = "niche U", ylim = c(0, 0.3), xlab = "Niche breadth",
                title = paste0(dataset, ", background = ", ifelse(bg_spec, "buffer", "whole study area")), filename = "niche_U~Niche breadth.pdf",
                width = 8)
# range unfilling:
scatterplot_fun(data = res_traits_df, x = niche_breadth_zcor, y = range_unfilling_std,
                ylab = "range U", ylim = c(0, 0.3), xlab = "Niche breadth",
                title = paste0(dataset, ", background = ", ifelse(bg_spec, "buffer", "whole study area")), filename = "range_U~Niche breadth.pdf")

# niche stability:
scatterplot_fun(data = res_traits_df, x = niche_breadth_zcor, y = niche_stability_std,
                ylab = "niche S", ylim = c(0, 1), xlab = "Niche breadth",
                title = paste0(dataset, ", background = ", ifelse(bg_spec, "buffer", "whole study area")), filename = "niche_S~Niche breadth.pdf",
                width = 8)
# range stability:
scatterplot_fun(data = res_traits_df, x = niche_breadth_zcor, y = range_stability_std,
                ylab = "range S", ylim = c(0, 1), xlab = "Niche breadth",
                title = paste0(dataset, ", background = ", ifelse(bg_spec, "buffer", "whole study area")), filename = "range_S~Niche breadth.pdf")
...
boxplot_fun(data = res_traits_df, x = Trophic.Level, y = D_range,
            ...
            title = paste0(dataset, ", background = ", ifelse(bg_spec, "buffer", "whole study area")), filename = "range_D~trophic_level.pdf")

boxplot_fun(data = res_traits_df, x = Trophic.Level, y = D_niche,
            ylab = "niche overlap D", ylim = c(0, 1), 
            title = paste0(dataset, ", background = ", ifelse(bg_spec, "buffer", "whole study area")), filename = "niche_D~trophic_level.pdf")
...
boxplot_fun(data = res_traits_df, x = Trophic.Level, y = diff_range_niche_D,
            ...
            title = paste0(dataset, ", background = ", ifelse(bg_spec, "buffer", "whole study area")), filename = "diff_rangeD_niche_D~trophic_level.pdf",
            width = 8)

### stability ~ trophic level:
boxplot_fun(data = res_traits_df, x = Trophic.Level, y = range_stability_std,
            ylab = "range S", ylim = c(0.7, 1), 
            title = paste0(dataset, ", background = ", ifelse(bg_spec, "buffer", "whole study area")), filename = "range_S~trophic_level.pdf")
boxplot_fun(data = res_traits_df, x = Trophic.Level, y = niche_stability_std,
            ylab = "niche S", ylim = c(0.7, 1), 
            title = paste0(dataset, ", background = ", ifelse(bg_spec, "buffer", "whole study area")), filename = "niche_S~trophic_level.pdf")

### expansion ~ trophic level:
boxplot_fun(data = res_traits_df, x = Trophic.Level, y = range_expansion_std,
            ylab = "range E", ylim = c(0, 0.5), 
            title = paste0(dataset, ", background = ", ifelse(bg_spec, "buffer", "whole study area")), filename = "range_E~trophic_level.pdf")
boxplot_fun(data = res_traits_df, x = Trophic.Level, y = niche_expansion_std,
            ylab = "niche E", ylim = c(0, 0.5), 
            title = paste0(dataset, ", background = ", ifelse(bg_spec, "buffer", "whole study area")), filename = "niche_E~trophic_level.pdf")

### unfilling ~ trophic level:
boxplot_fun(data = res_traits_df, x = Trophic.Level, y = range_unfilling_std,
            ylab = "range U", ylim = c(0, 0.5), 
            title = paste0(dataset, ", background = ", ifelse(bg_spec, "buffer", "whole study area")), filename = "range_U~trophic_level.pdf")
boxplot_fun(data = res_traits_df, x = Trophic.Level, y = niche_unfilling_std,
            ylab = "niche U", ylim = c(0, 0.5), 
            title = paste0(dataset, ", background = ", ifelse(bg_spec, "buffer", "whole study area")), filename = "niche_U~trophic_level.pdf")
...
boxplot_fun(data = res_traits_df, x = Trophic.Level, y = cons_p_S_A_range,
            ...
            title = paste0(dataset, ", background = ", ifelse(bg_spec, "buffer", "whole study area")), filename = "range_cons_p_S~trophic_level.pdf")
boxplot_fun(data = res_traits_df, x = Trophic.Level, y = cons_p_S_A_niche,
            ylab = "niche conservatism p-value S", ylim = c(0, 1), 
            title = paste0(dataset, ", background = ", ifelse(bg_spec, "buffer", "whole study area")), filename = "niche_cons_p_S~trophic_level.pdf")
...
boxplot_fun(data = res_traits_df, x = Trophic.Level, y = shift_p_S_A_range,
            ...
            title = paste0(dataset, ", background = ", ifelse(bg_spec, "buffer", "whole study area")), filename = "range_shift_p_S~trophic_level.pdf")
boxplot_fun(data = res_traits_df, x = Trophic.Level, y = shift_p_S_A_niche,
            ylab = "niche shift p-value S", ylim = c(0, 1), 
            title = paste0(dataset, ", background = ", ifelse(bg_spec, "buffer", "whole study area")), filename = "niche_shift_p_S~trophic_level.pdf")
...
boxplot_fun(data = res_traits_df, x = Habitat, y = D_range,
            ylab = "range overlap D", ylim = c(0, 1), 
            title = paste0(dataset, ", background = ", ifelse(bg_spec, "buffer", "whole study area")), filename = "range_D~Habitat.pdf",
            width = 10)
boxplot_fun(data = res_traits_df, x = Habitat, y = D_niche,
            ylab = "niche overlap D", ylim = c(0, 1), 
            title = paste0(dataset, ", background = ", ifelse(bg_spec, "buffer", "whole study area")), filename = "niche_D~Habitat.pdf",
            width = 10)
...
boxplot_fun(data = res_traits_df, x = Habitat, y = diff_range_niche_D,
            ylab = "range D - niche D", ylim = range(res_traits_df$diff_range_niche_D), 
            title = paste0(dataset, ", background = ", ifelse(bg_spec, "buffer", "whole study area")), filename = "diff_rangeD_niche_D~Habitat.pdf",
            width = 8)
...
boxplot_fun(data = res_traits_df, x = Habitat, y = range_stability_std,
            ...
            title = paste0(dataset, ", background = ", ifelse(bg_spec, "buffer", "whole study area")), filename = "range_S~Habitat.pdf",
            width = 8)
boxplot_fun(data = res_traits_df, x = Habitat, y = niche_stability_std,
            ylab = "niche S", ylim = c(0.5, 1), 
            title = paste0(dataset, ", background = ", ifelse(bg_spec, "buffer", "whole study area")), filename = "niche_S~Habitat.pdf",
            width = 8)
...
scatterplot_fun(data = res_traits_df, x = Mass, y = range_stability_std,
            ...
            title = paste0(dataset, ", background = ", ifelse(bg_spec, "buffer", "whole study area")), filename = "range_S~body_weight.pdf")
scatterplot_fun(data = res_traits_df, x = Mass, y = niche_stability_std,
            ylab = "niche S", ylim = c(0.5, 1), xlab = "Body weight",
            title = paste0(dataset, ", background = ", ifelse(bg_spec, "buffer", "whole study area")), filename = "niche_S~body_weight.pdf",
            width = 8)
...
scatterplot_fun(data = res_traits_df, x = Mass, y = range_expansion_std,
                ...
                title = paste0(dataset, ", background = ", ifelse(bg_spec, "buffer", "whole study area")), filename = "range_E~body_weight.pdf")
scatterplot_fun(data = res_traits_df, x = Mass, y = niche_expansion_std,
                ylab = "niche E", ylim = c(0, 0.5), xlab = "Body weight",
                title = paste0(dataset, ", background = ", ifelse(bg_spec, "buffer", "whole study area")), filename = "niche_E~body_weight.pdf",
                width = 8)
...
boxplot_fun(data = res_traits_df, x = Trophic.Niche, y = D_range,
            ylab = "range overlap D", ylim = c(0, 1), 
            title = paste0(dataset, ", background = ", ifelse(bg_spec, "buffer", "whole study area")), filename = "range_D~trophic_niche.pdf",
            width = 10)
boxplot_fun(data = res_traits_df, x = Trophic.Niche, y = D_niche,
            ylab = "niche overlap D", ylim = c(0, 1), 
            title = paste0(dataset, ", background = ", ifelse(bg_spec, "buffer", "whole study area")), filename = "niche_D~trophic_niche.pdf",
            width = 10)
# difference range D - niche D:
boxplot_fun(data = res_traits_df, x = Trophic.Niche, y = diff_range_niche_D,
            ylab = "range D - niche D", ylim = range(res_traits_df$diff_range_niche_D), 
            title = paste0(dataset, ", background = ", ifelse(bg_spec, "buffer", "whole study area")), filename = "diff_rangeD_niche_D~trophic_niche.pdf",
            width = 8)
...
boxplot_fun(data = res_traits_df, x = Primary.Lifestyle, y = D_range,
            ylab = "range overlap D", ylim = c(0, 1), 
            title = paste0(dataset, ", background = ", ifelse(bg_spec, "buffer", "whole study area")), filename = "range_D~primary_lifestyle.pdf",
            width = 10)
boxplot_fun(data = res_traits_df, x = Primary.Lifestyle, y = D_niche,
            ylab = "niche overlap D", ylim = c(0, 1), 
            title = paste0(dataset, ", background = ", ifelse(bg_spec, "buffer", "whole study area")), filename = "niche_D~primary_lifestyle.pdf",
            width = 10)

# difference range D - niche D:
boxplot_fun(data = res_traits_df, x = Primary.Lifestyle, y = diff_range_niche_D,
            ylab = "range D - niche D", ylim = range(res_traits_df$diff_range_niche_D), 
            title = paste0(dataset, ", background = ", ifelse(bg_spec, "buffer", "whole study area")), filename = "diff_rangeD_niche_D~primary_lifestyle.pdf",
            width = 8)
...
boxplot_fun(data = res_traits_df, x = as.factor(Migration), y = D_range,
            ylab = "range overlap D", ylim = c(0, 1), 
            title = paste0(dataset, ", background = ", ifelse(bg_spec, "buffer", "whole study area")), filename = "range_D~Migration.pdf")
boxplot_fun(data = res_traits_df, x = as.factor(Migration), y = D_niche,
            ylab = "niche overlap D", ylim = c(0, 1), 
            title = paste0(dataset, ", background = ", ifelse(bg_spec, "buffer", "whole study area")), filename = "niche_D~Migration.pdf")

# difference range D - niche D:
boxplot_fun(data = res_traits_df, x = as.factor(Migration), y = diff_range_niche_D,
            ylab = "range D - niche D", ylim = range(res_traits_df$diff_range_niche_D), 
            title = paste0(dataset, ", background = ", ifelse(bg_spec, "buffer", "whole study area")), filename = "diff_rangeD_niche_D~migration.pdf",
            width = 8)
