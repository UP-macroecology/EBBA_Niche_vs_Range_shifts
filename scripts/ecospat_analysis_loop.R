...
RangeContraction<-nrow(EBBA_Cells[which(EBBA_Cells$EBBA1_Status == 'pres'
                                             & EBBA_Cells$EBBA2_Status =='abs'),]) /nrow(EBBA1_Cells) #presented as a proportion of the hisoric range, to compare with niche unfilling from ecospat, which uses the historic data.
...
##Calculate magnitude of niche centroid shift with some phythagoras##
