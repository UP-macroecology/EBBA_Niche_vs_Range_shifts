###Run Ecospat Analyses with full climatic background to quanify overall climate shift between time periods###
...
#It is recommended to use at least 1000 replications for the equivalency test.
#eq.test <- ecospat.niche.equivalency.test(grid.clim.historic, grid.clim.recent, rep = 1500, overlap.alternative = "higher", expansion.alternative = "lower", stability.alternative = "higher", unfilling.alternative = "lower")
#saveRDS(eq.test, file = paste("./Data/Europe_ebba_species/European_Bioclimate_Niche_equivilency_test.Rds",sep=""))
#EuropeanBioclimateTestMetrics<-eq.test
#readRDS("data/04_eq-test_1500-rep_overl-h_exp-l_sta-h_unf-l.Rds")

# plot equivalency test
#tiff(filename = paste("./Data/Europe_ebba_species/Niche_Analyses_summaries/European_Bioclimate_Niche_equivilency_test.tiff",sep=""))
#ecospat.plot.overlap.test(eq.test, "D", "Niche Equivalency")
#dev.off()
